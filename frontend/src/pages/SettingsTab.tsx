    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {(['Account', 'APR (%)', 'Min. Payment ($)'] as const).map(h => (
        ...
        {terms.map((term, i) => (
          ...
          >
            ...
            <input
              ...
              onChange={e => updateField(i, 'apr', e.target.value)}
              style={{
                width: '100%',
            ...
            <input
              ...
              onChange={e => updateField(i, 'min_payment', e.target.value)}
              style={{
                width: '100%',
                padding: '0.375rem 0.5rem',
                borderRadius: '0.375rem',
  ...
  return (
    <div style={{ maxWidth: 700 }}>
      ...
      <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', marginBottom: '1rem' }}>
        Set the APR and minimum payment for each debt account. Values marked{' '}
        <strong style={{ color: 'var(--accent-blue)' }}>custom</strong> override
        the estimated defaults and are persisted to the local database.
        Includes paid-off accounts so you can pre-configure cards you plan to use again.
      </p>
